...
\begin{equation*}
  ...
  \begin{cases}
    \sigma^2 &= \omega_r, \\
    \sigma_L^2 &= \frac{\omega_r}{\omega_l}.
  \end{cases}
\end{equation*}
Підставимо значення $\omega_r = 2.5 \cdot 10^{-5}$ і $\omega_l = 10$
\begin{equation*}
  \begin{cases}
    \sigma^2 &= 2.5 \cdot 10^{-5}, \\
    \sigma_L^2 &= 2.5 \cdot 10^{-6}.
  \end{cases}
\end{equation*}
Бачимо,
що автори цього алгоритму поставили жорстке обмеження щодо якості зображення
та методу знаходження опорних точок.
